...
//                        mMainAct.setTangoTitleColor(Color.RED);
//                        mMainAct.setTangoTitleText("Tango Initializing (hold still)...");
//                    }else{
//                        mMainAct.setTangoTitleColor(mLocalized? Color.rgb(0,180,0) : Color.rgb(180,0,0));
//                        mMainAct.setTangoTitleText((mLocalized? "Localized" : "Not Localized") + " ADF: " + mCurrentADFName);
//                    }
//                    mMainAct.setStatusText(statusText(mStatus));
//                }
//
//                if(pose.baseFrame==TangoPoseData.COORDINATE_FRAME_AREA_DESCRIPTION
...
//                    mMainAct.setRotationText(String.format("YRot:%.2f", rot));
//                    mMainAct.setTranslationText("Translation: " + translation);
//
